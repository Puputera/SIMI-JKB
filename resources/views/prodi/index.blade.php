...
@section('content')
    <h2 class="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl">Data Program
        studi</h2>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        onclick="edit({{ $item->id }}, '{{ addslashes($item->nama) }}', '{{ addslashes($item->jurusan_id) }}')"
    ...
    @include('prodi.edit')
    @include('prodi.delete')

    <script>
        function edit(id, nama, jurusan_id) {
            document.getElementById('id').value = id;
            document.getElementById('edit-nama').value = nama;
            document.getElementById('edit-jurusan_id').value = jurusan_id;

            let form = document.getElementById('edit-form');
            form.action = "{{ route('prodi.update', '') }}/" + id;
        }
        ...
        function destroy(id) {
            ...
            form.action = "{{ route('prodi.destroy', '') }}/" + id;
        }
    </script>
@endsection
