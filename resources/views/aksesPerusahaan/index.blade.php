...
@section('title', 'Akses Perusahaan')

@section('content')
    <h2 class="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl">Data Akses Perusahaan</h2>
    ...
    <script>
        function destroy(id) {
            ...
            form.action = "{{ route('dosen.destroy', '') }}/" + id;
        }
    </script>
@endsection
