...
@section('content')
    <h2 class="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl">Data Jurusan
    </h2>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        onclick="edit({{ $item->id }}, '{{ addslashes($item->nama) }}')"
    ...
    <script>
        function edit(id, nama) {
            ...
            form.action = "{{ route('jurusan.update', '') }}/" + id;
        }
        ...
        function destroy(id) {
            ...
            form.action = "{{ route('jurusan.destroy', '') }}/" + id;
        }
    </script>
@endsection
