...
@section('title', 'pertanyaanKuisioner')

@section('content')
    <h2 class="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl">Data Pertanyaan Kuisioner
    </h2>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-left text-sm text-gray-500 rtl:text-right">
            ...
            <tbody>
                @if ($pertanyaanKuisioner)
                    @foreach ($pertanyaanKuisioner as $item)
                        <tr
        ...
        {{-- pagination --}}
        {{ $pertanyaanKuisioner->links() }}
    </div>
    @include('pertanyaanKuisioner.create')
    @include('pertanyaanKuisioner.edit')
    @include('pertanyaanKuisioner.delete')
    ...
    <script>
        function edit(id, pertanyaan) {
            ...
            form.action = "{{ route('pertanyaanKuisioner.update', '') }}/" + id;
        }
        ...
        function destroy(id) {
            ...
            form.action = "{{ route('pertanyaanKuisioner.destroy', '') }}/" + id;
        }
    </script>
@endsection
