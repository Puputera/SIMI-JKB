...
@section('content')
    <h2 class="mb-4 text-2xl font-bold leading-none tracking-tight text-gray-900 md:text-4xl">Data Pengguna</h2>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                                        onclick="edit({{ $item->id }}, '{{ addslashes($item->username) }}', '{{ addslashes($item->email) }}', '{{ addslashes($item->role) }}')"
    ...
    <script>
        function edit(id, username, email, role) {
            ...
            form.action = "{{ route('user.update', '') }}/" + id;
        }
